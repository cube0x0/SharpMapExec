...
namespace SharpKatz.Win32
{
    internal class Natives
    {
        ...
        {
            private LUID TokenId;
            public LUID AuthenticationId;
            private LARGE_INTEGER ExpirationTime;
            private TOKEN_TYPE TokenType;
            private SECURITY_IMPERSONATION_LEVEL ImpersonationLevel;
            private uint DynamicCharged;
            private uint DynamicAvailable;
            private uint GroupCount;
            private uint PrivilegeCount;
            private LUID ModifiedId;
        }
        ...
        private struct OBJECT_BASIC_INFORMATION
        {
            ...
            private ACCESS_MASK GrantedAccess;
            private uint HandleCount;
            private uint PointerCount;
            private uint PagedPoolCharge;
            private uint NonPagedPoolCharge;

            [MarshalAs(UnmanagedType.ByValArray, SizeConst = 3)]
            private uint[] Reserved;

            private uint NameInfoSize;
            private uint TypeInfoSize;
            private uint SecurityDescriptorSize;
            private LARGE_INTEGER CreationTime;
        }
        ...
        {
            private IntPtr apfnEncoder;//ASN1BerEncFun_t
            private IntPtr apfnDecoder;//ASN1BerDecFun_t
        }

        [StructLayout(LayoutKind.Sequential)]
        public struct ASN1module_t
        {
            private uint nModuleName;
            private ASN1encodingrule_e eRule;
            private uint dwFlags;
            private uint cPDUs;

            //__field_xcount(cPDUs)
            private IntPtr apfnFreeMemory;//ASN1FreeFun_t

            //__field_xcount(cPDUs)
            private IntPtr acbStructSize;//uint

            private ASN1BerFunArr_t BER;
        }
        ...
        public struct ASN1encoding_s
        {
            ...
            //__field_bcount(size)
            private IntPtr buf;    /* buffer to encode into */

            private uint size;   /* current size of buffer */
            private uint len;    /* len of encoded data in buffer */
            private ASN1error_e err;    /* error code for last encoding */
            private uint bit;
            private IntPtr pos;
            private uint cbExtraHeader;
            private ASN1encodingrule_e eRule;
            private uint dwFlags;
        }
        ...
        {
            private uint magic;  /* magic for this structure */
            private uint version;/* version number of this library */
            private IntPtr module; /* module this decoding_t depends to */

            //__field_bcount(size)
            private IntPtr buf;    /* buffer to decode from */

            private uint size;   /* size of buffer */
            private uint len;    /* len of decoded data in buffer */
            private ASN1error_e err;    /* error code for last decoding */
            private uint bit;
            private IntPtr pos;
            private ASN1encodingrule_e eRule;
            private uint dwFlags;
        ...
        {
            private UInt64 PagedPoolLimit;
            private UInt64 NonPagedPoolLimit;
            private UInt64 MinimumWorkingSetSize;
            private UInt64 MaximumWorkingSetSize;
            private UInt64 PagefileLimit;
            private LARGE_INTEGER TimeLimit;
        }
        ...
        {
            private uint DispatchTableCount;
            private IntPtr DispatchTable;//RPC_DISPATCH_FUNCTION
        ...
        {
            private IntPtr RpcProtocolSequence;
