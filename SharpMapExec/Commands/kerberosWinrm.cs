...
using System.IO;
using static SharpMapExec.Lib.kerberoswinrm;
...
namespace SharpMapExec.Commands
{
    public class kerberosWinrm : ICommand
    {
        ...
        public void Execute(Dictionary<string, string> arguments)
        {
            ...
            KerberosWinRm(users, domain, passwords, hashes, ticket, encType, dc, computernames, module, moduleargument, path, destination, flags);
        }
    }
}