...
namespace SharpKatz.Module
{
    internal class Msv1
    {
        ...
        public struct KIWI_MSV1_0_LIST_62
        {
            ...
            private LUID SecondaryLocallyUniqueIdentifier;
            private UNICODE_STRING UserName;
            private UNICODE_STRING Domaine;
            public IntPtr unk14;
            public IntPtr unk15;
            private UNICODE_STRING Type;
            public IntPtr pSid;
            public int LogonType;
            public IntPtr unk18;
            public int Session;
            private LARGE_INTEGER LogonTime; // autoalign x86
            private UNICODE_STRING LogonServer;
        ...
        {
            private UNICODE_STRING LogonDomainName;
            private UNICODE_STRING UserName;

            [MarshalAs(UnmanagedType.ByValArray, SizeConst = LM_NTLM_HASH_LENGTH)]
            private byte[] NtOwfPassword;

            [MarshalAs(UnmanagedType.ByValArray, SizeConst = LM_NTLM_HASH_LENGTH)]
            private byte[] LmOwfPassword;

            [MarshalAs(UnmanagedType.ByValArray, SizeConst = SHA_DIGEST_LENGTH)]
            private byte[] ShaOwPassword;

            private byte isNtOwfPassword;
            private byte isLmOwfPassword;
            private byte isShaOwPassword;
            /* buffer */
        }
        ...
        public struct MSV1_0_PRIMARY_CREDENTIAL_10_1607
        {
            private UNICODE_STRING LogonDomainName;
            private UNICODE_STRING UserName;
            private IntPtr pNtlmCredIsoInProc;
            private byte isIso;
            private byte isNtOwfPassword;
            private byte isLmOwfPassword;
            private byte isShaOwPassword;
            private byte isDPAPIProtected;
            private byte align0;
            private byte align1;
            private byte align2;
            private uint unkD; // 1/2 DWORD

            //#pragma pack(push, 2)
            private ushort isoSize;  // 0000 WORD

            [MarshalAs(UnmanagedType.ByValArray, SizeConst = LM_NTLM_HASH_LENGTH)]
            private byte[] DPAPIProtected;

            private uint align3; // 00000000 DWORD
