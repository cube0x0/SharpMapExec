...
{
    internal class WinBuild2004 : IWinBuild
    {
        ...
        private byte[] PTRN_W2004_SspCredentialList = { 0x24, 0x43, 0x72, 0x64, 0x41, 0x48, 0xff, 0x15 };
        ...
        public WinBuild2004()
        {
            ...
            KerberosPrimaryCredentialType = typeof(SharpKerberos.KIWI_KERBEROS_10_PRIMARY_CREDENTIAL_1607);
            ...
            KerberosLogonSessionType = typeof(SharpKerberos.KIWI_KERBEROS_LOGON_SESSION_10_1607);
            KerberosHashType = typeof(SharpKerberos.KERB_HASHPASSWORD_6_1607);
